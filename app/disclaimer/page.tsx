    ...
    <div className="flex flex-col items-center justify-center py-32 px-8 bg-black min-h-[80vh]">
      <div className="glass-card max-w-2xl w-full p-16 text-center space-y-16 border-t-2 border-t-emerald-500 fade-in-up">
        ...
        <div className="space-y-12">
          <p className="text-white font-montserrat text-xs md:text-sm leading-loose tracking-[0.2em] font-light">
          ...
          <p className="text-slate-500 font-montserrat text-[10px] md:text-[11px] leading-relaxed tracking-[0.15em] font-light">
